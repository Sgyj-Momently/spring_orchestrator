...
public record PhotoGroupingResult(
    ...
    /**
     * 그룹화 응답 아티팩트가 아직 없는 대역 구현에서 쓰는 축약 생성자다.
     *
     * @param groupingStrategy 그룹화 에이전트가 실제 적용한 enum 전략 값
     * @param groupCount 후속 대표 사진 선택 단계가 예상할 수 있는 생성 그룹 수
     */
