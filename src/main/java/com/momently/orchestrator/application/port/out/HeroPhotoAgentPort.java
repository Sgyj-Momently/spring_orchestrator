...
/**
 * 대표 사진 선택 단계를 application 계층에서 호출하기 위한 outbound 포트다.
 *
 * <p>이 포트는 오케스트레이터가 대표 사진 선택 에이전트의 HTTP 주소, 입력 DTO, 모델 세부사항을
 * 직접 알지 못하게 하는 경계다. 구현체는 그룹화 결과 artifact와 사진 정보 bundle을 읽어
...
public interface HeroPhotoAgentPort {
     ...
     * @param photoGroupingResult 사진 그룹화 단계가 남긴 grouping result artifact 참조
     * @return 대표 사진 선택 결과의 요약 및 artifact 경로
     */
