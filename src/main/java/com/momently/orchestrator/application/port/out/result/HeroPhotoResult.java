 ...
 *
 * <p>대표 사진 선택 결과는 후속 outline/draft 단계에서 사용될 수 있다. 오케스트레이터는
 * 대용량 본문 대신 artifact 경로와 최소 카운터만 유지한다.</p>
 *
 * @param heroPhotoCount 선택된 대표 사진 수(보통 그룹 수와 같음)
 * @param resultPath 대표 사진 선택 결과 JSON artifact 경로
 */
public record HeroPhotoResult(
    ...
    /**
     * artifact 경로가 아직 없는 대역 구현에서 쓰는 축약 생성자다.
     *
