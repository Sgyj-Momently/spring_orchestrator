 ...
 *
 * @param publicPhotoCount downstream 단계에 공개 가능한 사진 수
 * @param excludedPhotoCount 공개 결과에서 제외한 사진 수
 * @param resultPath privacy review JSON artifact 경로
 * @param sanitizedBundlePath 공개 가능 사진만 남긴 bundle JSON artifact 경로
 */
